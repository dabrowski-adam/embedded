...
//Resetuje karte gdy OK zwraca 0
u08 mmcReset(void);

//Wysyla komenda MMC do karty i zwraca kod statusu
u08 mmcSendCommand(u08 cmd, u32 arg);

//Odczytuje sektor karty
u08 mmcRead(u08* buffer,u32 sector);

//Zapisuje sektor karty
u08 mmcWrite(u08* buffer,u32 sector);

// Wydaje komende do kary
u08 mmcCommand(u08 cmd, u32 arg);

// zwraca pojemnosc karty w bajtach 
