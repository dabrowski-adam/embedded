...
#define I2SCLH_SCLH			0x00000190  /* I2C SCL Duty Cycle High Reg */	//I2C buss is too fast for current config
#define I2SCLL_SCLL			0x00000190  /* I2C SCL Duty Cycle Low Reg */	//Need to slow it down due to E2PROM //was 0x80
