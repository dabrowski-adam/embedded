...
void SPI0_Test( void )
{
    ...
    IOCLR0 = SPI0_SEL;
    							/* The tested SPI device is an Atmel 25160 */
    ...
    for ( i = 0; i < BUFSIZE - 3; i++ )	/* Init RD and WR buffer */    
    {
		SPIWRData[i+3] = i + 10;	/* leave two bytes for cmd and addr */
