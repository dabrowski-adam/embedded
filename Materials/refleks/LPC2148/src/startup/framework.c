 ...
 *
 * Description:
 *    Returns the programCounter read from lr register.
 *
 ****************************************************************************/
inline unsigned int
getProgramCounter(void)
{
  unsigned int programCounter = 0;
  asm volatile ("mov %[var], %%lr" : [var] "=r" (programCounter));
...
{
  unsigned int          value = getProgramCounter() - (unsigned int)0x04;
...
{
  unsigned int          value = getProgramCounter() - (unsigned int)0x08;
